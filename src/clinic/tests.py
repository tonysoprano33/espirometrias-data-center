...
class DashboardInlineUpdateTests(TestCase):
    ...
    def test_secretary_mode_prioritizes_attendance_and_hides_clinical_controls(self):
        ...
        self.assertIn('data-agenda-count="total"', html)
        self.assertIn('data-agenda-count="attended"', html)
        self.assertIn('data-agenda-count="no_show"', html)
        self.assertIn('data-agenda-count="waiting"', html)
